        ...
        public async Task<ResponseObject<DataResponseProject>> CreateProject(Request_CreateProject request)
        {
            ...
            if (team == null)
            {
                return new ResponseObject<DataResponseProject>
                {
                    ...
                    Message = "Không tìm thấy đội ngũ của người dùng",
                    Data = null
                };
            }
            ...
            if (teamLeader == null || !teamLeader.Name.Equals("Technical"))
            {
                return new ResponseObject<DataResponseProject>
                {
                    Status = StatusCodes.Status400BadRequest,
            ...
            var leaderRoles = await _userRepository.GetRolesOfUserAsync(leader);
            if (!leaderRoles.Contains("Leader"))
            {
